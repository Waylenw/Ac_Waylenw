...
public class AppShortCutUtil {
	...
	public  static void init(Class classSplash){
		AppShortCutUtil.classSplash=classSplash;
	}
	...
	public static void addShortCust(Context context,int resAPPIcon,int resAPPName) {
		...
		// 解决点击app图标重新启动的问题
		intentShort.setClass(context, AppShortCutUtil.classSplash);
	...
	public static void delShortCust(Context context,int resAPPName) {
		...
		intentShort1.setClass(context, AppShortCutUtil.classSplash);
