...
public class ClipView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawLine(0, clipTopMargin, clipLeftMargin + clipWidth, clipTopMargin, borderPaint);
		canvas.drawLine(0, clipTopMargin + clipHeight, clipLeftMargin + clipWidth, clipTopMargin + clipHeight, borderPaint);
		// canvas.drawRect(clipLeftMargin, clipTopMargin, clipLeftMargin + clipWidth, clipTopMargin + clipHeight, borderPaint);
